...
object Stopwords {
  ...
  val English = List(
    ...
    "gives", "go", "goes", "going", "gone", "got", "gotten", "greetings", "h", "had", "hadn't",
    ...
    "i", "i'd", "i'll", "i'm", "i've", "ie", "if", "ignored", "immediate", "in",
    "inasmuch", "inc", "indeed", "indicate", "indicated", "indicates", "inner", "insofar", "instead", "into",
    "inward", "is", "isn't", "it", "it'd", "it'll", "it's", "its", "itself", "j",
    "just", "k", "keep", "keeps", "kept", "know", "knows", "known", "l", "last",
    "lately", "later", "latter", "latterly", "least", "less", "lest", "let", "let's", "like",
    "liked", "likely", "little", "look", "looking", "looks", "ltd", "m", "mainly", "many",
    ...
    "specified", "specify", "specifying", "still", "sub", "such", "sup", "sure", "t", "t's",
    ...
    "used", "useful", "uses", "using", "usually", "uucp", "v", "value", "various", "very",
    "via", "viz", "vs", "w", "want", "wants", "was", "wasn't", "way", "we",
    ...
    "you'll", "you're", "you've", "your", "yours", "yourself", "yourselves", "z", "zero", "a’s",
    "ain’t", "aren’t", "c’mon", "c’s", "can’t", "couldn’t", "didn’t", "doesn’t", "don’t", "hadn’t",
    "hasn’t", "haven’t", "he’s", "here’s", "i’d", "i’ll", "i’m", "i’ve", "isn’t", "it’d",
    "it’ll", "it’s", "let’s", "shouldn’t", "t’s", "that’s", "there’s", "they’d", "they’ll", "they’re",
    "they’ve", "wasn’t", "we’d", "we’ll", "we’re", "we’ve", "weren’t", "what’s", "where’s", "who’s",
    "won’t", "wouldn’t", "you’d", "you’ll", "you’re", "you’ve", "dear", "tis", "twas")
}
