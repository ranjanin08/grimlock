...
class Ensemble(args: Args) extends Job(args) {
  ...
  val schema = List(("entity.id", Content.parse(StringCodec, NominalSchema[String]())),
    ("label", Content.parse(LongCodec, NominalSchema[Long]())),
    ("x", Content.parse(DoubleCodec, ContinuousSchema[Double]())),
    ("y", Content.parse(DoubleCodec, ContinuousSchema[Double]())),
    ("z", Content.parse(DoubleCodec, ContinuousSchema[Double]())))
