...
trait DoubleOperator[P <: Position, Q <: Position] extends Operator[P, Q] {
  ...
  val pos: Locate.FromPairwiseInput[P, Q]
...
/** Add two values. */
case class Plus[P <: Position, Q <: Position](pos: Locate.FromPairwiseInput[P, Q]) extends DoubleOperator[P, Q] {
  val inverse: Boolean = false
  protected def compute(l: Double, r: Double) = l + r
}

/** Subtract two values. */
case class Minus[P <: Position, Q <: Position](pos: Locate.FromPairwiseInput[P, Q],
  inverse: Boolean = false) extends DoubleOperator[P, Q] {
  protected def compute(l: Double, r: Double) = l - r
}

/** Multiply two values. */
case class Times[P <: Position, Q <: Position](pos: Locate.FromPairwiseInput[P, Q]) extends DoubleOperator[P, Q] {
  val inverse: Boolean = false
  protected def compute(l: Double, r: Double) = l * r
}

/** Divide two values. */
case class Divide[P <: Position, Q <: Position](pos: Locate.FromPairwiseInput[P, Q],
  inverse: Boolean = false) extends DoubleOperator[P, Q] {
  protected def compute(l: Double, r: Double) = l / r
}
 ...
 */
case class Concatenate[P <: Position, Q <: Position](pos: Locate.FromPairwiseInput[P, Q],
