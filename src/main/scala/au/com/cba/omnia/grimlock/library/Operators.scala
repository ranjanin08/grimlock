...
trait DoubleOperator[P <: Position[P], Q <: Position[Q]] extends Operator[P, Q] {
...
/** Add two values. */
case class Plus[P <: Position[P], Q <: Position[Q]](pos: Locate.FromPairwiseCells[P, Q]) extends DoubleOperator[P, Q] {
