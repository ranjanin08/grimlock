...
trait Compactable[
  ...
  def combineMaps[
    ...
    x: Map[S, P#C[R]],
    y: Map[S, P#C[R]]
  ): Map[S, P#C[R]] = x ++ y.map { case (k, v) => k -> combineMapValues(x.get(k), v) }

  protected def combineMapValues[R <: Position[R] with ExpandablePosition[R, _]](x: Option[P#C[R]], y: P#C[R]): P#C[R]
}
...
object Compactable {
  ...
  implicit val cp2: Compactable[Position1D, Position2D] = new Compactable[Position1D, Position2D] {
    protected def combineMapValues[
      ...
      x: Option[Position2D#C[R]],
      y: Position2D#C[R]
    ): Position2D#C[R] = merge(x, y)
  }
  ...
  implicit val cp3: Compactable[Position2D, Position3D] = new Compactable[Position2D, Position3D] {
    protected def combineMapValues[
      ...
      x: Option[Position3D#C[R]],
      y: Position3D#C[R]
    ): Position3D#C[R] = merge(x, y)
  }
  ...
  implicit val cp4: Compactable[Position3D, Position4D] = new Compactable[Position3D, Position4D] {
    protected def combineMapValues[
      ...
      x: Option[Position4D#C[R]],
      y: Position4D#C[R]
    ): Position4D#C[R] = merge(x, y)
  }
  ...
  implicit val cp5: Compactable[Position4D, Position5D] = new Compactable[Position4D, Position5D] {
    protected def combineMapValues[
      ...
      x: Option[Position5D#C[R]],
      y: Position5D#C[R]
    ): Position5D#C[R] = merge(x, y)
  }
  ...
  implicit val cp6: Compactable[Position5D, Position6D] = new Compactable[Position5D, Position6D] {
    protected def combineMapValues[
      ...
      x: Option[Position6D#C[R]],
      y: Position6D#C[R]
    ): Position6D#C[R] = merge(x, y)
  }
  ...
  implicit val cp7: Compactable[Position6D, Position7D] = new Compactable[Position6D, Position7D] {
    protected def combineMapValues[
      ...
      x: Option[Position7D#C[R]],
      y: Position7D#C[R]
    ): Position7D#C[R] = merge(x, y)
  }
  ...
  implicit val cp8: Compactable[Position7D, Position8D] = new Compactable[Position7D, Position8D] {
    protected def combineMapValues[
      ...
      x: Option[Position8D#C[R]],
      y: Position8D#C[R]
    ): Position8D#C[R] = merge(x, y)
  }
  ...
  implicit val cp9: Compactable[Position8D, Position9D] = new Compactable[Position8D, Position9D] {
    protected def combineMapValues[
      ...
      x: Option[Position9D#C[R]],
      y: Position9D#C[R]
    ): Position9D#C[R] = merge(x, y)
  }
