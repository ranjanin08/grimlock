...
class TestSparkPositions extends TestPositions {
  ...
  it should "return its Third over names" in {
    toRDD(data)
      .map { case (s, i) => Position3D(s, i, i + 1) }
      .names(Over(Third))
      .toList.sortBy(_._1) shouldBe List((Position1D(1), 5), (Position1D(2), 0), (Position1D(3), 1),
  ...
  it should "return its Second along names" in {
    toRDD(data)
      .map { case (s, i) => Position3D(s, i, i + 1) }
      .names(Along(Second))
      .toList.sortBy(_._1) shouldBe List((Position2D("fid:A", 1), 0), (Position2D("fid:B", 2), 2),
  ...
  it should "return its First along names" in {
    toRDD(data)
      .map { case (s, i) => Position4D(s, i, i + 1, i + 2) }
      .names(Along(First))
      .toList.sortBy(_._1) shouldBe List((Position3D(0, 1, 2), 3), (Position3D(1, 2, 3), 5), (Position3D(2, 3, 4), 4),
  ...
  it should "return its Third along names" in {
    toRDD(data)
      .map { case (s, i) => Position4D(s, i, i + 1, i + 2) }
      .names(Along(Third))
      .toList.sortBy(_._1) shouldBe List((Position3D("fid:A", 0, 2), 4), (Position3D("fid:B", 1, 3), 2),
  ...
  it should "return its Fifth over names" in {
    toRDD(data)
      .map { case (s, i) => Position5D(s, i, i + 1, i + 2, i + 3) }
      .names(Over(Fifth))
      .toList.sortBy(_._1) shouldBe List((Position1D(3), 0), (Position1D(4), 3), (Position1D(5), 1),
  ...
  it should "return its Second along names" in {
    toRDD(data)
      .map { case (s, i) => Position5D(s, i, i + 1, i + 2, i + 3) }
      .names(Along(Second))
      .toList.sortBy(_._1) shouldBe List((Position4D("fid:A", 1, 2, 3), 1), (Position4D("fid:B", 2, 3, 4), 3),
  ...
  it should "return its Fourth along names" in {
    toRDD(data)
      .map { case (s, i) => Position5D(s, i, i + 1, i + 2, i + 3) }
      .names(Along(Fourth))
      .toList.sortBy(_._1) shouldBe List((Position4D("fid:A", 0, 1, 3) ,0), (Position4D("fid:B", 1, 2, 4), 2),
